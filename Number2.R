...
?scale
?log
ggplot(data = size_mr_data, aes (x = body_mass, y = metabolic_rate , size =5)) + geom_line()
ggplot(data = size_mr_data, aes (x = body_mass, y = metabolic_rate)) + geom_line(size = 5) + scale_x_log10() + scale_y_log10()
